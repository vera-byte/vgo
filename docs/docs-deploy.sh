...
if [ -n "$CODESPACES" ]; then
    ...
    git push -f git@github.com:cool-team-official/vgo.git master:gh-pages
fi

# 如果发布到 https://<USERNAME>.github.io
# git push -f git@github.com:Vgo/Vgo.github.io.git master:gh-pages
# git push -f https://github.com/vera-byte/vgo.git master:gh-pages
