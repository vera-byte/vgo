...
const (
	cPackUsage = `vgo-tools pack SRC DST`
	cPackBrief = `packing any file/directory to a resource file, or a go file`
	cPackEg    = `
vgo-tools pack public data.bin
vgo-tools pack public,template data.bin
vgo-tools pack public,template packed/data.go
vgo-tools pack public,template,config packed/data.go
vgo-tools pack public,template,config packed/data.go -n=packed -p=/var/www/my-app
vgo-tools pack /var/www/public packed/data.go -n=packed
`
